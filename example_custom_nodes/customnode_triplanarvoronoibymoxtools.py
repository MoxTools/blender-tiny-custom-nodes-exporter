bl_info = {
    "name": "Custom Node - TriplanarVoronoiByMoxTools",
...
class Generated_TriplanarVoronoiByMoxTools_Node(ShaderNodeCustomGroup):
    bl_idname = 'ShaderNode_TriplanarVoronoiByMoxTools_Generated'
    bl_label = 'TriplanarVoronoiByMoxTools'
    bl_icon = 'NONE'
    ...
    def init(self, context):
        ...
        tree_name = f'.internal_TriplanarVoronoiByMoxTools_' + str(id(self))
        ...
        try: sock.default_value = bpy.data.node_groups['TriplanarVoronoiByMoxTools'].interface.items_tree[0].default_value
        except: pass
        ...
        node_Mix_002.location_absolute = (1697.825439453125, 57.29985427856445)
        try: node_Mix_002.location_absolute = Vector((1697.825439453125, 57.29985427856445))
        except: pass
        ...
        try: node_Image_Texture.image = None
        except: pass
        ...
        try: node_Image_Texture_001.image = None
        except: pass
        ...
        try: node_Image_Texture_004.image = None
        except: pass
        ...
        try: node_Image_Texture_002.image = None
        except: pass
        ...
        try: node_Image_Texture_006.image = None
        except: pass
        ...
        try: node_Image_Texture_005.image = None
        except: pass
        ...
        try: group.links.new(created_nodes['Group Input'].outputs[0], created_nodes['Math.001'].inputs[0])
        except: pass
        try: group.links.new(created_nodes['Math.001'].outputs[0], created_nodes['Math.002'].inputs[1])
        except: pass
        try: group.links.new(created_nodes['Group Input'].outputs[2], created_nodes['Math.004'].inputs[0])
        except: pass
        ...
        try: group.links.new(created_nodes['Group Input'].outputs[1], created_nodes['Math'].inputs[0])
        except: pass
...
def append_to_submenu(self, context):
    self.layout.operator("node.add_node", text="TriplanarVoronoiByMoxTools").type = Generated_TriplanarVoronoiByMoxTools_Node.bl_idname

def register():
    bpy.utils.register_class(Generated_TriplanarVoronoiByMoxTools_Node)
...
def unregister():
    ...
    bpy.utils.unregister_class(Generated_TriplanarVoronoiByMoxTools_Node)
